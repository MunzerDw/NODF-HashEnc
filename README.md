...
Put these files under the <code>data</code> folder. If you have these files under a different folder, you can set the path to it using this flag: ```--data <path to your data folder>```
